...
bcm2711_gpio_registers_t * gpio_base;
...
static void my_timer_func(struct timer_list *unused){
  ...
  set_gpio_mode(gpio_base, GPIO_PIN, led_status);
...
{
  gpio_base = (bcm2711_gpio_registers_t *) ioremap(RPI4_GPIO_BASE,
  sizeof(bcm2711_gpio_registers_t)); 

  set_gpio_function(gpio_base, GPIO_PIN, 1);
  int result;
